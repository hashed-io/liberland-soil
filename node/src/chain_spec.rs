...
use liberland_runtime::{
	...
	BalancesConfig, GenesisConfig, GrandpaConfig, ImOnlineConfig, IndicesConfig, SessionConfig,
		...
		move || {
			testnet_genesis(
				...
				vec![
					...
					// authority #7
					(
						hex!["f64bae0f8fbe2eb59ff1c0ff760a085f55d69af5909aed280ebda09dc364d443"]
							.into(),
						hex!["ca907b74f921b74638eb40c289e9bf1142b0afcdb25e1a50383ab8f9d515da0d"]
							.into(),
					...
					// authority #8
					(
						hex!["420a7b4a8c9f2388eded13c17841d2a0e08ea7c87eda84310da54f3ccecd3931"]
							.into(),
						hex!["ae69db7838fb139cbf4f93bf877faf5bbef242f3f5aac6eb4f111398e9385e7d"]
							.into(),
...
fn testnet_genesis(
	...
	GenesisConfig {
		...
		babe: Some(BabeConfig {
			authorities: vec![],
			epoch_config: Some(liberland_runtime::BABE_GENESIS_EPOCH_CONFIG),
		})
		.unwrap(),
		im_online: Some(ImOnlineConfig { keys: vec![] }).unwrap(),
		authority_discovery: Some(AuthorityDiscoveryConfig { keys: vec![] }).unwrap(),
		// collective_Instance1: Some(Default::default()).unwrap(),
		grandpa: Some(GrandpaConfig { authorities: vec![] }).unwrap(),
